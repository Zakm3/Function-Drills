...
const printName = word => `Your name here ${word}`
// console.log(printName('Zak'))
...
//CODE HERE
const greeting = word => `Hello, ${word}`
// console.log(greeting('Zak'))
...
// console.log(compareNums(870, 879))
...
function nameCheck(name1){
  if ( name1 === 'Steven'){
   return ('What is up Steven?')
      ...
      } let nameGreeting = nameCheck('Zak')
